...
Data Scientist with 7+ years building ML models, statistical systems, and data pipelines across pharma (Amgen) and financial services (American Express). Currently focused on ML engineering, NLP, and bringing models from notebooks to production.
